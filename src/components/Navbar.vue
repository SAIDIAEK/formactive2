  ...
  <nav class="bg-gray-200 border-gray-200 dark:bg-gray-900 dark:border-gray-700">
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <router-link :to="{ name: 'home' }" class="flex items-center space-x-3 rtl:space-x-reverse" @click="handleMenuClick">
        ...
        <button data-collapse-toggle="navbar-multi-level" type="button" @click="toggleMenu"
          class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
          aria-controls="navbar-multi-level" :aria-expanded="isMenuOpen.toString()">
        ...
        <div :class="['w-full md:block md:w-auto', isMenuOpen ? 'block' : 'hidden']" id="navbar-multi-level">
          <ul
            ...
            <li>
              <Navlink name="home" title="Home" @click="toggleMenu" />
            </li>
            <li>
                ...
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownLargeButton">
                  ...
                  <li aria-labelledby="dropdownNavbarLink">
                    <button id="doubleDropdownButton" data-dropdown-toggle="doubleDropdown"
                      ...
                      Dropdown<svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="m1 1 4 4 4-4" />
                      </svg>
                    </button>
